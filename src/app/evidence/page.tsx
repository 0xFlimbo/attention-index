...
const DESCRIPTION =
  "Every verified record behind this project's derived metrics — posts, amplifications and media references — each linked to its public source.";
 ...
 * media — a simple table is enough." Record-oriented, which is what
 * differentiates this route from `/archive`'s editorial view: every
